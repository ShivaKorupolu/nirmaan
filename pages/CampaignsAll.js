  ...
  return (
    ...
    <section className=" bg-nirmaan-secondary px-2 lg:px-20">
          <div className="flex justify-center items-center mt-10 lg:mt-0">
            <h1 className="lg:text-3xl text-nirmaan-darker text-center  md:text-2xl text-xl font-bold inter lg:mt-7 lg:mb-4 md:mt-7 md:mb-4 underline underline-offset-8">
              OUR CAMPAIGNS
            </h1>
