...
const[mobile4,setMobile4]=useState(false);
...
{/*---------------------------------------------------- Menu buttons---------------------------------------------------------------- */}
      <section className="overflow-hidden relative lg:px-20">
            ...
            <div className="flex flex-wrap items-center">
              <div className="w-auto hidden lg:block">
                <div className="inline-block">
                  <button
                    className="font-bold py-2 w-32 mx-1 text-sm poppin rounded-3xl border border-nirmaan transition ease-in-out duration-200 hover:text-white hover:bg-nirmaan text-gray-500"
                    type="button"
...
<div className="inline-block bg-nirmaan rounded-3xl hover:bg-nirmaan-dark">
                  <button
                    className="font-bold py-2 w-32 mx-1 text-sm poppin  border-nirmaan transition ease-in-out duration-200 hover:text-blue-50  text-white"
                    type="button"
                    contenteditable="false"
                  >
                    Donate Now
     ...
     {/*----------------------------------------- mobile view starts here ------------------------------------------*/}
        ...
        >
          <div className=" lg:hidden block navbar-menu fixed top-0 left-0 bottom-0 w-full h-screen sm:max-w-xs z-50">
            ...
            <nav className="relative  z-10 pt-4 bg-white h-auto border overflow-y-auto">
              <div className="flex flex-wrap justify-between h-full">
                ...
                <div className="flex flex-col justify-start pt-8  border-t-2 w-full h-screen">
                  <ul className="poppin">
                    <div className="flex justify-between  mb-4 px-4 " onClick={() =>
                            setMobile1((mobile1) => !mobile1)
                          }>
                      <li className="mb-2"> <a className="text-gray-800 px-1 font-bold" href="#"> Who we are</a>
                      </li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                          ...
                          <div className="flex flex-wrap justify-between h-full">
                            ...
                            <div className="flex flex-col justify-start pt-3  border-t-2 w-full h-screen">
                              <div
                                ...
                                onClick={() => setMobile1((mobile1) => !mobile1)}
                              >
                                {" "}
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                      ...
                      onClick={() => setMobile2((mobile2) => !mobile2)}
                    >
                      <li className="mb-2">
                        {" "}
                        <a
                    ...
                    <div
                      className="flex justify-between  mb-4 px-4"
                      onClick={() => setMobile3((mobile3) => !mobile3)}
                    >
                      <li className="mb-2">
                        {" "}
                        <a
                    ...
                    <div
                      className="flex justify-between  mb-4 px-4"
                      onClick={() => setMobile4((mobile4) => !mobile4)}
                    >
                      <li className="mb-2">
                        {" "}
                        <a
                      ...
                      <div className=" lg:hidden block navbar-menu fixed top-0 left-0 bottom-0 w-full h-screen sm:max-w-xs z-50">
                        ...
                        <nav className="relative  z-10 px-2 pt-4 bg-white h-auto border overflow-y-auto">
                          <div className="flex flex-wrap justify-between h-full">
                            ...
                            <div className="flex flex-col justify-start pt-3  border-t-2 w-full h-screen">
                              <div
                                className="hover:text-gray-700 group  text-center font-bold text-sm mb-6  flex"
                                onClick={() => setMobile4((mobile4) => !mobile4)}
                              >
                                {" "}
                                <svg
                              ...
                              <ul className="poppin px-8 mb-4">
                                <li className="mb-4">
                                  {" "}
                                  <a
                                    className=" hover:text-gray-700 text-sm px-1 font-semibold"
                                    href="#"
                                  >
                                    Donate for Indu
                                  </a>
                                ...
                                <li className="mb-4">
                                  ...
                                  <a
                                    ...
                                    href="#"
                                  >
                                   Donate for Scholl Adoption Program
                                  </a>
                                </li>
                                <li className="mb-4">
                                  {" "}
                    ...
                    <div className="w-full flex justify-start px-4 items-center ">
                      <div className="flex items-center">
                        <div className="w-auto flex justify-between items-center">
                          <div className="inline-block">
                            <button
                              className="py-1 w-40 text-large popi border hover:border-gray-300  focus:ring focus:ring-gray-50 bg-blue-500 transition ease-in-out duration-200 hover:bg-blue-800 text-lg  text-white"
                              type="button"
                              contenteditable="false"
                            >
                              Volunteer
                          ...
                          <div className="inline-block">
                            <button
                              className="py-1 w-40 mx-1 text-large popi border hover:border-gray-300  focus:ring focus:ring-gray-50 bg-blue-500 transition ease-in-out duration-200 hover:bg-blue-800 text-lg  text-white"
                              type="button"
                              contenteditable="false"
                            >
                              Donation
...
<Transition
      ...
      >
          <div
            className="w-full h-auto px-20 transition-all duration-1000 absolute opacity-100 z-50  group  group-hover:duration-500 border  border-b-0 border-t-nirmaan-600   "
            onMouseLeave={() => {
              setWho(false);
            }} 
          >
...
<Transition
      ...
      >
          ...
          >
            <section className="pt-2  bg-gray-200 overflow-hidden">
              <div className=" mx-auto">
              <h3 className="mb-2 font-extrabold pt-4 leading-normal text-xl text-center underline underline-offset-8  ">
                        Nirmaan Located
                      </h3>
                <div className="pb-10">
                  <div className="flex flex-wrap ">
                    <div className="p-10 ">
                      <h3 className="mb-6 font-extrabold leading-normal text-base text-gray-800   ">
                        Telangana
                      </h3>
                      <ul>
                        <li className="mb-3.5  font-black ">
      ...
      >
          ...
          >
            <section className="pt-2  bg-gray-200 overflow-hidden">
              <div className=" mx-auto">
                <div className="pb-10">
                <h3 className="mb-2 font-extrabold leading-normal underline underline-offset-8 pt-4 text-lg flex justify-center items-center text-center  ">
                      No one has ever become poor by giving
                      </h3> 
                  <div className="flex flex-wrap ">
                    <div className="p-10 ">
                    <h3 className="mb-4 font-extrabold leading-normal text-base text-gray-800 ">
                      Our Campaigns
                      </h3> 
                      <ul>
                        <li className="mb-3.5  font-black ">
